    ...
    def get_backbone(parti_num, names_list, model_name):
        ...
        if names_list == None:
            if model_name=='f2dc':
                ...
                for j in range(parti_num):
                    nets_list.append(resnet10_dc_pg_ml_office(num_classes=FedLeaOfficeCaltech.N_CLASS,
                                                              gum_tau=FedLeaOfficeCaltech.model_args.gum_tau,
                                                              proto_weight=pw,
                                                              attn_temperature=tau_attn,
                                                              ml_lite_channel=lc,
                ...
                for j in range(parti_num):
                    nets_list.append(resnet10_f2dc_dse_office(
                        num_classes=FedLeaOfficeCaltech.N_CLASS,
                        gum_tau=FedLeaOfficeCaltech.model_args.gum_tau,
