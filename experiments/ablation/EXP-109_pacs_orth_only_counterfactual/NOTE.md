...
**probe_sty_class** (✅ 3-seed 完成):
| Seed | linear | MLP-16 | MLP-64 | MLP-128 | MLP-256 |
|------|--------|--------|--------|---------|---------|
| 2 | 0.240 | 0.268 | 0.694 | 0.713 | 0.813 |
| 15 | 0.295 | 0.288 | 0.752 | 0.752 | 0.865 |
| 333 | 0.235 | 0.621 | 0.620 | 0.843 | 0.833 |
| **mean** | **0.257** | 0.392 | **0.689** | **0.769** | **0.837** |

**对比 EXP-108 CDANN 3-seed mean**: linear=0.962 / MLP-64=0.958 / MLP-256=0.960
- **Δ (CDANN - orth_only)**: **+70.5pp linear / +26.9pp m64 / +12.3pp m256**
