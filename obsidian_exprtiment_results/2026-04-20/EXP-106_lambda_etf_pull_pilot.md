...
### seed=2 主结果 (rescued JSON 全量指标)

| λ_etf_pull | seed | ALL Best | ALL Last | AVG Best | AVG Last | AVG Max@R |
|-----------|------|----------|----------|----------|----------|-----------|
| **0 (EXP-102 baseline)** | 2 | **81.36** | **79.77** | **88.13** | **86.74** | @R45 |
| **0.003** | 2 | 80.57 | 77.37 | 87.98 | **83.88** | @R34 |
| **0.01**  | 2 | 80.96 | **79.78** | 88.09 | **87.46** | @R42 |
| **0.03**  | 2 | **81.36** | 79.77 | **88.39** | 86.74 | @R53 |

**Δ vs EXP-102 baseline (四指标对照)**:

| λ | Δ ALL Best | Δ ALL Last | Δ AVG Best | Δ AVG Last |
|---|-----------|-----------|-----------|-----------|
| 0.003 | -0.79 | **-2.40** | -0.15 | **-2.86** ❌ 崩盘 |
| 0.01  | -0.40 | +0.01 | -0.04 | **+0.72** ✅ Last 最稳 |
| 0.03  | **±0.00** | **±0.00** | **+0.26** | **±0.00** ✅ Peak 最高 |
