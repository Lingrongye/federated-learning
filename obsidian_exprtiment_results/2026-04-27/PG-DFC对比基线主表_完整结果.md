...
| **F2DC+DSE+LAB rho=0.3 v2c** (EXP-151, 2-seed) | 64.07 | 75.00 | 56.90 | 60.00 | **63.99** ✅ | 58.92 | 5.07 | R80.0 |
| **F2DC+DSE+LAB rho=0.5 v2c** (EXP-151, 2-seed) | 63.40 | 75.27 | **62.93** | 50.00 | 62.90 | 60.83 | 2.07 | R91.5 |
| **F2DC+DSE+LAB rho=0.2 v2c** (EXP-152, 2-seed) | 63.39 | **77.37** | 59.49 | 53.34 | 63.40 | 58.37 | 5.03 | R82.5 |
| **F2DC+DSE+LAB rho=0.1 v2c** (EXP-152, 2-seed) | 63.39 | 75.53 | 59.48 | 53.33 | 62.93 | 58.22 | 4.71 | R76.0 |
| **F2DC+DSE+LAB rho=0.3 std** (EXP-152, 2-seed) | 63.62 | 76.84 | 58.62 | 46.67 | 61.44 | 59.43 | **2.01** ⭐ | R77.0 |
...
| **F2DC+DSE+LAB rho=0.3 v2c** (EXP-151) | 15   | R85    | 63.84   | 71.58  | 60.34 | **63.33** ⭐ | **64.77** | 59.33     | sub1 |
| **F2DC+DSE+LAB rho=0.3 v2c** (EXP-151) | 333  | R75    | 64.29   | **78.42** | 53.45 | 56.67 | 63.21   | 58.52     | sub2 |
| **F2DC+DSE+LAB rho=0.5 v2c** (EXP-151) | 15   | R91    | 61.61   | 72.11  | **67.24** ⭐ | 53.33 | 63.57   | 61.26     | sub1 |
| **F2DC+DSE+LAB rho=0.5 v2c** (EXP-151) | 333  | R92    | 65.18   | **78.42** | 58.62 | 46.67 | 62.22   | 60.40     | sub2 |
| **F2DC+DSE+LAB rho=0.2 v2c** (EXP-152) | 15   | R86    | 61.16   | **77.37** | 56.90 | 50.00 | 61.36   | 58.26     | sub1 |
| **F2DC+DSE+LAB rho=0.2 v2c** (EXP-152) ⭐⭐ | 333  | R79    | 65.62   | **77.37** | **62.07** ⭐ | 56.67 | **65.43** ⭐⭐ | 58.47     | sub2 |
| **F2DC+DSE+LAB rho=0.1 v2c** (EXP-152) | 15   | R81    | 62.05   | 72.63  | 60.34 | 53.33 | 62.09   | 57.39     | sub1 |
| **F2DC+DSE+LAB rho=0.1 v2c** (EXP-152) | 333  | R71    | 64.73   | **78.42** | 58.62 | 53.33 | 63.78   | 59.05     | sub2 |
| **F2DC+DSE+LAB rho=0.3 std** (EXP-152) | 15   | R75    | 61.61   | 75.26  | 56.90 | 50.00 | 60.94   | 57.50     | sub1 |
| **F2DC+DSE+LAB rho=0.3 std** (EXP-152) | 333  | R79    | 65.62   | **78.42** | 60.34 | 43.33 | 61.93   | **61.36** ⭐ | sub2 |
...
### F2DC+DSE+LAB 新方法结论 (EXP-151 + EXP-152, 2-seed s=15+s=333)

| 配置 | AVG_B | vs F2DC+DaA (63.55) | vs PG-DFC+DaA (64.69) | gap | 备注 |
|---|:---:|:---:|:---:|:---:|:---:|
| **rho=0.3 v2c** (EXP-151) | **63.99** ✅ | **+0.44** | -0.70 | 5.07 | paper-grade marginal pass |
| rho=0.2 v2c (EXP-152) | 63.40 | -0.15 | -1.29 | 5.03 | A2 single seed 65.43 大胜 ⭐⭐ |
| rho=0.5 v2c (EXP-151) | 62.90 | -0.65 | -1.79 | **2.07** ⭐ | webcam 67.24 单 seed 强 (s=15) |
| rho=0.1 v2c (EXP-152) | 62.93 | -0.62 | -1.76 | 4.71 | DSE 太弱 |
| **rho=0.3 std** (EXP-152) | 61.44 | -2.11 | -3.25 | **2.01** ⭐⭐ | gap 最稳 / final 最稳 |

**单 seed 大胜**:
- **EXP-152 A2 s=333 rho=0.2 v2c R79 best 65.43 ⭐⭐** = Office 历史单 seed-pair 最高 (4 域全胜 F2DC+DaA s=333: caltech +1.33 / amazon +2.63 / webcam +1.73 / dslr +3.34)
- EXP-151 s=15 rho=0.5 R91 webcam **67.24** ⭐ — 单域跟 PG-DFC+DaA 持平

**反直觉发现** (webcam 跟 rho 非单调, s=15 best):
| rho | webcam (s=15) |
|---|:---:|
| 0.5 (EXP-151) | **67.24** ⭐⭐ (跟 DaA 持平) |
| 0.3 (EXP-151) | 60.34 |
| 0.2 (EXP-152) | **56.90** (最差) |
| 0.1 (EXP-152) | 60.34 |

→ **rho=0.5 强 DSE 反而最救 webcam**, 但牺牲 dslr (53.33 vs rho=0.3 dslr 63.33)
→ **rho=0.3 v2c 是 trade-off 最优** (mean 63.99, dslr 63.33 救回, webcam 60.34 保住)
→ **rho=0.3 standard mode (关 small_protect) gap 最小 (2.01)**, final 最稳 (drop -0.58 vs v2c drop -5pp), 但 best 拖低

**vs PG-DFC+DaA 排名 (3-seed)**: PG-DFC+DaA 64.69 > F2DC+DSE+LAB rho=0.3 v2c 63.99 ≈ F2DC+DaA 63.55, **F2DC+DSE+LAB 暂未超越 PG-DFC+DaA**, 但 single-seed 最高 (65.43) 已超 PG-DFC+DaA 任何 single-seed。Paper claim 需要 P3 3-seed (s=2 加进来) 才能稳判定。
